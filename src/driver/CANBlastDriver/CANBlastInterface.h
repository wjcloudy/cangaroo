...
class CANBlastInterface: public CanInterface {
public:
    CANBlastInterface(CANBlastDriver *driver, int index, QString name, bool fd_support);
    virtual ~CANBlastInterface();
